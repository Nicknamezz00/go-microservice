...
import (
	ginpromethues "github.com/Nicknamezz00/go-microservice/internal/pkg/transports/http/middleware/ginpromethues"
...
func (_m *Option) Execute(_a0 *ginpromethues.GinPrometheus) {
	_m.Called(_a0)
}
